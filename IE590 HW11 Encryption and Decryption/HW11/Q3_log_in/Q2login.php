 ...
 <form action = "createaccount.php" method="POST">
      <h1> Please enter your information to create a new login account</h1>
        <p>  
          ...
          <label><h3>Password: </label><input type = "password" name = "pwd" id="pwd' /></h3>
          <br/>
          <br/>
        </p>
      <input type = "submit" name="submit_btn" class="submit_btn" id = "submit" value = "Create Account"/>
      <input type = "reset"  name="reset_btn" class="reset_btn" id = "reset" value = "reset"/>
	  
    </form>
	</br></br>
<h2><a href="loginaccount.php">Sign in</a></h2>
